...
if (isset($_POST["submit"])) {
    // Получить значение поля даты убытия клиента из формы
    $departure_date = $_POST["departure_date"];

    // Выполнить запрос на поиск клиентов с указанной датой убытия
    $sql = "SELECT * FROM архив WHERE дата_убытия = '$departure_date'";
...
<th>Серия и номер документа</th><th>Дата рождения</th><th>Пол</th><th>Домашний адрес</th><th>Домашний телефон</th></tr>';
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr><td>" . $row["номер_регистрации_клиента"] . "</td>";
            ...
            echo "<td>" . $row["домашний_телефон"] . "</td></tr>";
        }
        ...
        echo "<div class='NotFound'>Клиентов с указанной датой убытия не найдено</div>";
        echo '</div>'; // wrapper
        echo '</body>';
        echo '</html>';
    }
